...
const Skills = () => {
  ...
  return (
    <div name='skills' className='bg-gradient-to-b from-sky-400 to-blue-700 w-full text-white'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            <div className='pb-0'>
                <p className='text-4xl font-bold inline border-b-4 border-gray-500'>Skills</p>
                <p className='py-6'>Check out some of my technologies I have experience with here</p>
            </div>
